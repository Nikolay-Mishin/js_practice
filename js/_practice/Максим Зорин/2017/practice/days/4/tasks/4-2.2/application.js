document.addEventListener("DOMContentLoaded", function() {
  showGroups();
  showTable();
  menu('studentsPage', 'studentsMenu');
});

var previousMenuHeader,
    previousPage;

function menu(pageId, headerId) {
  var header = document.getElementById(headerId);
  if (previousMenuHeader) previousMenuHeader.className = '';
  header.className = 'active';
  previousMenuHeader = header;

  if (previousPage) previousPage.style.display = 'none';
  previousPage = document.getElementById(pageId);
