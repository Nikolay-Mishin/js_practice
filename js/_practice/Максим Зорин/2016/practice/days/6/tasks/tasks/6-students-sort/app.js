...
function studentsTab(model) {
  showStudents(model, 'notsorted', model.people);
  ...
  headers.forEach(function(header) {
    ...
    th.addEventListener('click', function() { showStudents(model, header[0], header[1]); });
    tr1.appendChild(th);
  });
}

function showStudents(model, name, sortMethod) {
